...
-(CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout *)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath *)indexPath{
    if (self.needMask) {
        return CGSizeMake(self.bounds.size.width-30, 180);
    }else{
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (self.needMask) {
        cell.customBanner.RateLabel.text = self.InvestRates[itemIndex];
        cell.customBanner.LimitedDaysLabel.text = self.InvestDays[itemIndex];
        cell.customBanner.BounsLabel.text = self.Investbonus[itemIndex];
        cell.customBanner.NewLabel.text = self.InvestStyle[itemIndex];
        cell.customBanner.TopLeftView.image = self.InvestTopImage[itemIndex];

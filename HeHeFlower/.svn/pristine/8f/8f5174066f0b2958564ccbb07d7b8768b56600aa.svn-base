...
-(UIToolbar *)setToolbarStyle{
    ...
    [toolbar setBarTintColor:[ColorTools colorWithHexString:@"#F35167"]];
    ...
    toolbar.items=@[centerSpace,leftItem,centerSpace,centerSpace,centerSpace,rightItem,centerSpace];
    return toolbar;
}

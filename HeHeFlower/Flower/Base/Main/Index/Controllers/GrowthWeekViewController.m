...
#import "ZhuView.h"
@interface GrowthWeekViewController ()<NavBarDelegate,UIScrollViewDelegate>
@property(nonatomic, strong)NavBar *navBar;
@property(nonatomic, strong)UIScrollView *sc;
@end

@implementation GrowthWeekViewController
- (void)viewDidLoad {
    [super viewDidLoad];
...
- (void)initView{
    _navBar = [[NavBar alloc]initWithTitle:@"周成长报告" WithLeftImage:nil WithRightImage:[UIImage imageNamed:@"日历"]];
    ...
    ZhuView *view1 = [[ZhuView alloc]initWithFrame:CGRectMake(0, 150, MSWIDTH, 200) :@[@"一",@"二",@"三",@"四",@"五",@"六",@"日"]:@[@"60",@"90",@"100",@"80",@"20",@"30",@"40"]:[ColorTools colorWithHexString:@"f7a9a7"]];
    ...
    ZhuView *view2 = [[ZhuView alloc]initWithFrame:CGRectMake(0, 350, MSWIDTH, 200) :@[@"一",@"二",@"三",@"四",@"五",@"六",@"日"]:@[@"60",@"90",@"100",@"80",@"20",@"30",@"40"]:[ColorTools colorWithHexString:@"a6d5f3"] ];
    ...
    ZhuView *view3 = [[ZhuView alloc]initWithFrame:CGRectMake(0, 550, MSWIDTH, 200) :@[@"一",@"二",@"三",@"四",@"五",@"六",@"日"]:@[@"60",@"90",@"100",@"80",@"20",@"30",@"10"] :[ColorTools colorWithHexString:@"ffcf99"]];

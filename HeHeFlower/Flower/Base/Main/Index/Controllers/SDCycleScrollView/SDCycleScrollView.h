...
@property (nonatomic, copy) NSArray *InvestRates; //新手投资的利率
@property (nonatomic, copy) NSArray *InvestDays;  //投资期限
@property (nonatomic, copy) NSArray *Investbonus; //使用红包的限额
@property (nonatomic, copy) NSArray *InvestStyle; //使用红包的限额
@property (nonatomic, copy) NSArray *InvestTopImage; //左上角图片
